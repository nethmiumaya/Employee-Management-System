    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                <form method="GET" action="{{ route('departments.index') }}" class="flex items-center gap-4">
                    <div class="relative">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-150 {{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-25' }}">
                        <td class="py-4 px-6 text-gray-800 font-medium">{{ $department->department_id }}</td>
                        <td class="py-4 px-6 text-gray-800">{{ $department->department_name }}</td>
                        <td class="py-4 px-6">
                    ...
                    <tr>
                        <td colspan="3" class="text-center py-12">
                            ...
                            <p class="text-gray-600">Try adjusting your search criteria or add a new department</p>
                        </td>
                    </tr>
                    @endforelse
                    </tbody>
