...
<head>
    ...
    <title>{{ config('app.name', 'HRMS') }} - Employee Dashboard</title>
...
<div id="app">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <h2><i class="fas fa-user-circle mr-2"></i>HRMS</h2>
            <div class="subtitle">Employee Dashboard</div>
        </div>
        <div class="sidebar-menu">
            <div class="sidebar-menu-section">
                <div class="sidebar-menu-title">Main</div>
                <a href="{{ route('employee.dashboard') }}" class="sidebar-menu-item active">
                    <i class="fas fa-home"></i>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('employee.projects') }}" class="sidebar-menu-item">
                    <i class="fas fa-project-diagram"></i>
                    <span>My Projects</span>
                </a>
                <a href="{{ route('employee.leaves') }}" class="sidebar-menu-item">
                    <i class="fas fa-calendar-alt"></i>
                    <span>My Leaves</span>
                </a>
                <a href="{{ route('employee.teams') }}" class="sidebar-menu-item">
            ...
            <div class="sidebar-menu-section">
                ...
                <a href="#" class="sidebar-menu-item" onclick="openProfileModal()">
        ...
        <div class="dashboard-content">
            <div class="stats-grid">
                ...
                <div class="stats-card">
                    <div class="stats-header">
                        <div>
                            <div class="stats-value">{{ count($teams ?? []) }}</div>
                            <div class="stats-label">My Teams</div>
                        </div>
                ...
                <div class="stats-card">
                    <div class="stats-header">
                        <div>
                            <div class="stats-value">{{ count($leaves ?? []) }}</div>
                            <div class="stats-label">My Leaves</div>
                        </div>
                ...
                <div class="stats-card">
                    <div class="stats-header">
                        <div>
                            <div class="stats-value">{{ count($notifications ?? []) }}</div>
            ...
            <div class="charts-grid">
                <div class="chart-card">
                    <div class="chart-header">
                        <h3 class="chart-title">My Project Progress</h3>
                    </div>
                    <canvas id="projectChart" height="300"></canvas>
                </div>
                <div class="chart-card">
                    <div class="chart-header">
                        <h3 class="chart-title">Leave Status</h3>
                    </div>
            ...
            <div class="quick-actions">
                ...
                <div class="actions-grid">
                    <a href="{{ route('employee.leaves.create') }}" class="action-btn">
                    ...
                    <a href="{{ route('employee.projects') }}" class="action-btn">
                        <div class="action-icon">
                    ...
                    <a href="{{ route('employee.teams') }}" class="action-btn">
                        <div class="action-icon">
                            <i class="fas fa-users"></i>
                        </div>
                        <div class="action-content">
            ...
            <div class="activities-card">
                <div class="chart-header">
                    <h3 class="chart-title">Announcements</h3>
                </div>
                @foreach($announcements ?? [] as $announcement)
                <div class="activity-item">
                    <div class="activity-avatar"><i class="fas fa-bullhorn"></i></div>
                    <div class="activity-content">
                        <h4>{{ $announcement->title }}</h4>
                        <p>{{ $announcement->message }}</p>
                        <div class="activity-time">{{ $announcement->created_at->diffForHumans() }}</div>
                    </div>
                </div>
                @endforeach
...
<div id="profileModal" class="modal">
    <div class="modal-content" style="max-width: 700px;">
        ...
        <div class="modal-body">
            <form id="profileForm" action="{{ route('employee.profile.update') ?? '#' }}" method="POST">
                @csrf
                @method('PUT')
...
<script>
    // Copy the JS from admin dashboard for sidebar, modal, notification panel, etc.
    // ... (Paste all relevant JS from admin dashboard.blade.php <script> block) ...

    // Example: Project and Leave charts (replace with real data)
            ...
            new Chart(document.getElementById('projectChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Progress (%)',
                        data: [80, 55, 100],
                        backgroundColor: ['#f97316', '#ea580c', '#dc2626']
                    }]
                },
